...
برای جداسازی منطق `traverser` از پیاده‌سازی خاص گراف، یک `interface` عمومی با نام `GraphAdapter<V, E>` تعریف شده است. این `interface` چهار عملیات اصلی را در اختیار `Adapter`ها قرار می‌دهد:
...
### تقسیم کار
در این آزمایش تلاش شد تا تسک‌ها به طور یکسان بین اعضای تیم پخش شود. گام‌های اول و دوم و سوم تلاش شد به طور مساوی بین اعضا پخش شود و همچنین نهایی‌سازی گزارش نیز به سرگروه این آزمایش واگذار شد.

[لینک کانبان‌برد](https://github.com/users/Amirreza81/projects/4)
